            ...
            >
              ...
              <Grid item xs={12} md={12} style={{ padding: "24px 15px" }}>
                ...
                <p style={{ fontSize: "1.2em" }}>
                  Below is an interactive code generator that lets you explore
                  the visual results of the different settings.
                </p>
                <p style={{ fontSize: "1.1em", marginBottom: "10px" }}>
                  Basic config is already set. Play with the options, drop (or
                  select) files, copy to clipboard the code and you are done!
                </p>
                <p style={{ fontSize: "1.1em", marginBottom: "5px" }}>
                  For a plenty understanding of props and methods please check
                  them out on the{" "}
                  <a href="https://github.com/dropzone-ui/react#dropzone-ui-react-components-api">
                    documentation
                  </a>
                  .
                </p>
                <p
                  style={{
                    ...
                    marginBottom: "10px",
                    width: "100%",
                    backgroundColor: "#fbec99",
                  }}
                >
                  <b>Note: </b> Dropzone-ui.com is on beta. You may experience
                  some performance issues in this code generator. However, it
                  does not mean that Dropzone-ui components have that issue in
                  production. This is because of the huge amount of events
                  happening inside to generate the code. Any aditional issues or
                  suggestions, please make us notice on github{" "}
                  <a href="https://github.com/dropzone-ui/react/issues">
                    issues
                  </a>
                  :
                </p>
