...
export interface DropzoneHeaderNeoProps {
  maxFileSize?: number;
...
const DropzoneHeaderNeo: React.FC<DropzoneHeaderNeoProps> = (
  props: DropzoneHeaderNeoProps
) => {
  const {
    maxFileSize,
    numberOfValidFiles,
...
export default DropzoneHeaderNeo;
