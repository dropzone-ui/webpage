...
import { PreparingLoaderProps } from "./PreparingLoaderProps";

const PreparingLoader: React.FC<PreparingLoaderProps> = (
  props: PreparingLoaderProps
) => {
  const {
    size,
    color,
...
export default PreparingLoader;
